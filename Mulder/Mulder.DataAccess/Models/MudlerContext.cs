...
{
    public partial class MudlerContext : DbContext
    {
        public MudlerContext()
        {
        }

        public MudlerContext(DbContextOptions<MudlerContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                //Scaffold-DbContext "Server=SPN-PC002;Database=Mulder;user id=sa;password=sa" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Models -context MudlerContext -Project Mulder.DataAccess -force
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasOne(d => d.MatchesLineUp)
                    .WithMany(p => p.PlayersScore)
                    .HasForeignKey(d => d.MatchesLineUpId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_PlayersScore_MatchesLineUp");
            });
